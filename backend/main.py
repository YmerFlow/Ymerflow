...
mcp = FastApiMCP(
    ...
    description=(
        ...
        "1. list_environments(project_id) — discover the environments available to a project "
        "(super-public base runners + project-local). list_public_environments() browses the "
        "public gallery across all projects.\n"
